# 航发叶片设计智能体 - LangGraph版本

## 项目简介

这是一个基于LangGraph架构的航空发动机叶片智能设计系统，使用深度学习模型（UNet、ViT）实现性能目标到设计参数的逆向设计和性能评估。

**核心特性**：
- 🚀 基于LangGraph的工作流架构，流程清晰可控
- 🤖 支持OpenAI兼容的LLM（GPT、DeepSeek等）
- 🔧 三大核心功能：叶片设计、性能评估、3D可视化
- 📊 智能意图识别和参数提取
